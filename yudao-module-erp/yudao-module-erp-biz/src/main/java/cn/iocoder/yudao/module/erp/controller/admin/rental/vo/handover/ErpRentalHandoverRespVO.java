package cn.iocoder.yudao.module.erp.controller.admin.rental.vo.handover;
...
@Schema(description = "管理后台 - ERP 租赁交接单 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ErpRentalHandoverRespVO {

    @Schema(description = "交接编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "11756")
    @ExcelProperty("交接编号")
    private Long id;

    @Schema(description = "交接单号", requiredMode = Schema.RequiredMode.REQUIRED, example = "S123")
    @ExcelProperty("交接单号")
    private String no;
    ...
    @Schema(description = "交接项列表", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    public static class Item {
        ...
        @Schema(description = "交接项编号", example = "11756")
        private Long id;
