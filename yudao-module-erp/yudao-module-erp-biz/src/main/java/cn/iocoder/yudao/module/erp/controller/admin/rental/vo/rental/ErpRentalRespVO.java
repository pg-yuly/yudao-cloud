...
@Schema(description = "管理后台 - ERP 租赁库存 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ErpRentalRespVO {
    ...
    @Schema(description = "客户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "2802")
