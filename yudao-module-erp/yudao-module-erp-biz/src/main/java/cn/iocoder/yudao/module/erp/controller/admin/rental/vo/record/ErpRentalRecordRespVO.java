package cn.iocoder.yudao.module.erp.controller.admin.rental.vo.record;
...
@Schema(description = "管理后台 - ERP 租赁库存明细 Response VO")
@Data
@ExcelIgnoreUnannotated
public class ErpRentalRecordRespVO {
    ...
    @Schema(description = "客户编号", requiredMode = Schema.RequiredMode.REQUIRED, example = "32407")
